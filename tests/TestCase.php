...
namespace JeffersonGoncalves\Erp\Manufacturing\Tests;
...
abstract class TestCase extends Orchestra
{
    ...
    protected function setUp(): void
    {
        ...
        Factory::guessFactoryNamesUsing(function (string $modelName): string {
            ...
            foreach (['Manufacturing', 'Stock', 'Accounting', 'Core'] as $package) {
            ...
            return "JeffersonGoncalves\\Erp\\Manufacturing\\Database\\Factories\\{$basename}Factory";
        });
    }
    ...
    protected function getEnvironmentSetUp($app): void
    {
        ...
        $configPath = __DIR__.'/../config/erp-manufacturing.php';
        if (file_exists($configPath)) {
            $app['config']->set('erp-manufacturing', require $configPath);
        }
    }

    protected function defineDatabaseMigrations(): void
    {
        $tempPath = sys_get_temp_dir().'/laravel-erp-manufacturing-migrations';
        ...
        // across the core, accounting, stock and manufacturing packages (core
        // first, then accounting, then stock, then manufacturing).
        $ordered = array_merge(
