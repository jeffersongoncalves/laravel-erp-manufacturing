...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create($prefix.'routing_operations', function (Blueprint $table) use ($prefix) {
            $table->id();
            $table->foreignId('routing_id')->constrained($prefix.'routings')->cascadeOnDelete();
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists($prefix.'routing_operations');
    }
};
